  ...
  return (
    <div className="flex justify-center items-center h-full">
      <div className="flex flex-col justify-center items-center h-1/2 w-1/2">
        <div className="flex items-center text-center align-center justify-center text-3xl xl:text-2xl lg:text-xl md:text-lg sm:text-md xs:text-smh-4/5 w-full font-playfair-display pb-10">
          Welcome to FlatFish, where finding the perfect flatmate is smooth
          sailing! We've revolutionised the roommate search by focusing on what
